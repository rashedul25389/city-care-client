...
const IssueCard = ({ issue, refetch }) => {
    ...
    return (
        <div className="card w-full max-w-sm bg-white shadow-md rounded-lg border overflow-hidden">
            <img
...
//     return (
//         <div className="w-full max-w-sm bg-white shadow-md rounded-lg border overflow-hidden">
//             <img
//                 src={issue.image || 'https://via.placeholder.com/400'}
//                 alt={issue.title}
//                 className="h-48 w-full object-cover"
